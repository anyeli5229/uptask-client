...
export default function DashboardView() {
  ...
  const { data, isLoading } = useQuery({ //useQuery obtiene datos
    queryKey: ['projects'],
    queryFn: getProjects,
  })
  ...
  if (data && user) return (
    <>
      ...
      {data.length ? (
            ...
            <li key={project._id} className="flex justify-between gap-x-6 px-5 py-10">
              ...
              <div className="flex shrink-0 items-center gap-x-6">
                <Menu as="div" className="relative flex-none">
                  <MenuButton className="-m-2.5 block p-2.5 text-gray-500 hover:text-fuchsia-500 hover:cursor-pointer">
        ...
        <p className="text-center py-20">No hay proyectos registrados aún,
          <Link
            to="projects/create"
